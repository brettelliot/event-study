...
def main():
    ...
    logging.basicConfig(
        ...
        format='%(message)s',
        handlers=[
            logging.FileHandler('ms_naive_av.log', mode='w'),
    ...
    plotter = Plotter()
    #plotter.plot_car(ccr.cars, ccr.cars_std_err, ccr.num_events,look_back, look_forward, False, "ms_naive_av.pdf")
    plotter.plot_car_cavcs(ccr.num_events, ccr.cars, ccr.cars_std_err, ccr.cavcs, ccr.cavcs_std_err,
                           look_back, look_forward, False, 'ms_naive_av.pdf')
